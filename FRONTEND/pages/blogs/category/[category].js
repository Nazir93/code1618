                ...
                <div className="container">
                    <div className="toptitle">
                        <div className="toptitlecont flex">
                            <h1 data-aos="fade-right">Категория <span>{category}</span></h1>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    ...
                    <div className="latestpostsdata">
                        ...
                        <div className="latestposts">
                            {loading ? <Spinner /> : <>
                                {publishedData.length === 0 ? <h1 className='w-100 flex flex-center'>Нет новостей</h1> : <>
                                    {publishedData.map((blog) => {
                                        return <div className="lpost" data-aos="flip-right" key={blog._id}>
                                            ...
                                            <div className="lpostinfo">
                                                ...
                                                <p></p>
                                                <h4 className="flex"><img src="/img/me.png" alt="" /><span>by vbm coder</span></h4>
                                            </div>
                                        </div>
                                    })}
                                </>}
