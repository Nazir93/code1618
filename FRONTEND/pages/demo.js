                    ...
                    <div className="children-comments">
                        {comment.children.map((child) => (
                            <div className="child-comment" key={child._id}>
                                ...
                                <span>Ответить {child.parentName}</span>
                                <h4>Tема: <span>{child.title}</span></h4>
                            ...
                            <div className="leftsitedetails">
                                ...
                                <div className="blogslugcomments">
                                    {newComment.parentName && (
                                        <h2>Оставить комментарии {newComment.parentName}</h2>
                                    )}
                                    {!newComment.parentName && (
                                        <h2>Оставить комментарии</h2>
                                    )}
                                    <p></p>
                                    <form onSubmit={handleCommentSubmit} className="leaveareplyform">Ваш адрес электронной почты опубликован не будет.
                            ...
                            <div className="rightsitedetails">
                                ...
                                <div className="rightslugcategory">
                                    ...
                                    <ul>
                                        ...
                                        <Link href='/blogs/category/Корпоративные сайты'><li>Корморативные сайты <span>({allwork.filter(ab => ab.blogcategory[0] === "Корпоративные сайты").length})</span></li></Link>
