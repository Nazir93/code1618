            ...
            <div className="blogpage">
                <div className="titledashboard flex flex-sb">
                    <div data-aos="fade-right">
                        <h2>Все<span> новости</span></h2>
                        <h3>Администрирование</h3>
                    </div>
                    <div className="breadcrumb" data-aos="fade-left">
                        <BsPostcard /> <span>/</span><span>Новости</span>
                    </div>
                </div>
                <div className="blogstable">
                    <div className="flex gap-2 mb-1" data-aos="fade-left">
                        <h2>Искать новости по названию: </h2>
                        <input
                            type="text"
                            value={searchQuery}
                        ...
                        <tbody data-aos="fade-up">
                            {loading ? <>
                                ...
                                {publishedblogs.length === 0 ? (
                                    <tr>
                                        <td colSpan="4" className="text-center">Нет доступных новостей</td>
                                    </tr>
                                ) : (
                                        ...
                                        <tr key={blog._id} >
                                            ...
                                            <td>
                                                <div className='flex gap-2 flex-center'>
                                                    <Link href={'/blogs/edit/' + blog._id}><button title='edit'><FaEdit />изменить</button></Link>
                                                    <Link href={'/blogs/delete/' + blog._id}><button title='delete'><RiDeleteBin6Fill />удалить</button></Link>
                                                </div>
                                            </td>
                                        </tr>
                                    ))
